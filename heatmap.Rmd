...
Alexander Ovechkin's style of play is simply eletric. With an extremely hard and accurate slap shot mixed in with a deadly quick wrist shot, Ovechkin is a scoring machine. The Russian-born winger has cemented himself as one of the best Russians to ever play in the NHL.

```{r}
ovechkin.2015 = get.skater.data(analysis.2015, "Alex Ovechkin")
ovechkin.2016 = get.skater.data(analysis.2016, "Alex Ovechkin")
ovechkin.2017 = get.skater.data(analysis.2017, "Alex Ovechkin")
ovechkin.2018 = get.skater.data(analysis.2018, "Alex Ovechkin")
```

Let's get some of his stats.

```{r}
ovechkin.2015.sp = get.save.percent(ovechkin.2015)
ovechkin.2015.game.sp = get.game.save.percent(ovechkin.2015)
ovechkin.2016.sp = get.save.percent(ovechkin.2016)
ovechkin.2016.game.sp = get.game.save.percent(ovechkin.2016)
ovechkin.2017.sp = get.save.percent(ovechkin.2017)
ovechkin.2017.game.sp = get.game.save.percent(ovechkin.2017)
ovechkin.2018.sp = get.save.percent(ovechkin.2018)
ovechkin.2018.game.sp = get.game.save.percent(ovechkin.2018)

ovechkin.2015.gp = get.goal.percent(ovechkin.2015)
ovechkin.2015.game.gp = get.game.goal.percent(ovechkin.2015)
ovechkin.2016.gp = get.goal.percent(ovechkin.2016)
ovechkin.2016.game.gp = get.game.goal.percent(ovechkin.2016)
ovechkin.2017.gp = get.goal.percent(ovechkin.2017)
ovechkin.2017.game.gp = get.game.goal.percent(ovechkin.2017)
ovechkin.2018.gp = get.goal.percent(ovechkin.2018)
ovechkin.2018.game.gp = get.game.goal.percent(ovechkin.2018)

ovechkin.2015.spg = get.shots.per.goal(ovechkin.2015)
ovechkin.2015.game.spg = get.game.shots.per.goal(ovechkin.2015)
ovechkin.2016.spg = get.shots.per.goal(ovechkin.2016)
ovechkin.2016.game.spg = get.game.shots.per.goal(ovechkin.2016)
ovechkin.2017.spg = get.shots.per.goal(ovechkin.2017)
ovechkin.2017.game.spg = get.game.shots.per.goal(ovechkin.2017)
ovechkin.2018.spg = get.shots.per.goal(ovechkin.2018)
ovechkin.2018.game.spg = get.game.shots.per.goal(ovechkin.2018)
```
...
| Season | Save Percent | Goal Percent | Shots per Goal |
| ------ | ------------ | ------------ | -------------- |
| 2015-2016 | `r ovechkin.2015.sp` | `r ovechkin.2015.gp` | `r ovechkin.2015.spg` |
| 2016-2017 | `r ovechkin.2016.sp` | `r ovechkin.2016.gp` | `r ovechkin.2016.spg` |
| 2017-2018 | `r ovechkin.2017.sp` | `r ovechkin.2017.gp` | `r ovechkin.2017.spg` |
| 2018-2019 | `r ovechkin.2018.sp` | `r ovechkin.2018.gp` | `r ovechkin.2018.spg` |

Let's take a look at his heatmaps.

```{r}
ovechkin.2015.locations.plot = graph.shot.locations(ovechkin.2015, "#041E42", "#C8102E", "Alex Ovechkin (2015)")
ovechkin.2015.locations.plot

ovechkin.2016.locations.plot = graph.shot.locations(ovechkin.2016, "#041E42", "#C8102E", "Alex Ovechkin (2016)")
ovechkin.2016.locations.plot

ovechkin.2017.locations.plot = graph.shot.locations(ovechkin.2017, "#041E42", "#C8102E", "Alex Ovechkin (2017)")
ovechkin.2017.locations.plot

ovechkin.2018.locations.plot = graph.shot.locations(ovechkin.2018, "#041E42", "#C8102E", "Alex Ovechkin (2018)")
ovechkin.2018.locations.plot
```

Let's look at this goal percentage per game now.

```{r}
ovechkin.2015.gp.plot = graph.trend(ovechkin.2015.game.gp, "Shooting (Goal) Percentage", "#041E42", "#C8102E", "Alex Ovechkin (2015)")
ovechkin.2015.gp.plot

ovechkin.2016.gp.plot = graph.trend(ovechkin.2016.game.gp, "Shooting (Goal) Percentage", "#041E42", "#C8102E", "Alex Ovechkin (2016)")
ovechkin.2016.gp.plot

ovechkin.2017.gp.plot = graph.trend(ovechkin.2017.game.gp, "Shooting (Goal) Percentage", "#041E42", "#C8102E", "Alex Ovechkin (2017)")
ovechkin.2017.gp.plot

ovechkin.2018.gp.plot = graph.trend(ovechkin.2018.game.gp, "Shooting (Goal) Percentage", "#041E42", "#C8102E", "Alex Ovechkin (2018)")
ovechkin.2018.gp.plot
```
...
A Norris Trophy caliber defensemen, Erik Karlsson helped redefined the modern defender. His exceptional speed as well as his quick passing ability has him as a franchise talent.

```{r}
karlsson.2015 = get.skater.data(analysis.2015, "Erik Karlsson")
karlsson.2016 = get.skater.data(analysis.2016, "Erik Karlsson")
karlsson.2017 = get.skater.data(analysis.2017, "Erik Karlsson")
karlsson.2018 = get.skater.data(analysis.2018, "Erik Karlsson")
```

Let's get some of his stats.

```{r}
karlsson.2015.sp = get.save.percent(karlsson.2015)
karlsson.2015.game.sp = get.game.save.percent(karlsson.2015)
karlsson.2016.sp = get.save.percent(karlsson.2016)
karlsson.2016.game.sp = get.game.save.percent(karlsson.2016)
karlsson.2017.sp = get.save.percent(karlsson.2017)
karlsson.2017.game.sp = get.game.save.percent(karlsson.2017)
karlsson.2018.sp = get.save.percent(karlsson.2018)
karlsson.2018.game.sp = get.game.save.percent(karlsson.2018)

karlsson.2015.gp = get.goal.percent(karlsson.2015)
karlsson.2015.game.gp = get.game.goal.percent(karlsson.2015)
karlsson.2016.gp = get.goal.percent(karlsson.2016)
karlsson.2016.game.gp = get.game.goal.percent(karlsson.2016)
karlsson.2017.gp = get.goal.percent(karlsson.2017)
karlsson.2017.game.gp = get.game.goal.percent(karlsson.2017)
karlsson.2018.gp = get.goal.percent(karlsson.2018)
karlsson.2018.game.gp = get.game.goal.percent(karlsson.2018)

karlsson.2015.spg = get.shots.per.goal(karlsson.2015)
karlsson.2015.game.spg = get.game.shots.per.goal(karlsson.2015)
karlsson.2016.spg = get.shots.per.goal(karlsson.2016)
karlsson.2016.game.spg = get.game.shots.per.goal(karlsson.2016)
karlsson.2017.spg = get.shots.per.goal(karlsson.2017)
karlsson.2017.game.spg = get.game.shots.per.goal(karlsson.2017)
karlsson.2018.spg = get.shots.per.goal(karlsson.2018)
karlsson.2018.game.spg = get.game.shots.per.goal(karlsson.2018)
```
...
| Season | Save Percent | Goal Percent | Shots per Goal |
| ------ | ------------ | ------------ | -------------- |
| 2015-2016 | `r karlsson.2015.sp` | `r karlsson.2015.gp` | `r karlsson.2015.spg` |
| 2016-2017 | `r karlsson.2016.sp` | `r karlsson.2016.gp` | `r karlsson.2016.spg` |
| 2017-2018 | `r karlsson.2017.sp` | `r karlsson.2017.gp` | `r karlsson.2017.spg` |
| 2018-2019 | `r karlsson.2018.sp` | `r karlsson.2018.gp` | `r karlsson.2018.spg` |

Let's take a look at his heatmaps.

```{r}
karlsson.2015.locations.plot = graph.shot.locations(karlsson.2015, "#E31837", "#C69214", "Erik Karlsson (2015)")
karlsson.2015.locations.plot

karlsson.2016.locations.plot = graph.shot.locations(karlsson.2016, "#E31837", "#C69214", "Erik Karlsson (2016)")
karlsson.2016.locations.plot

karlsson.2017.locations.plot = graph.shot.locations(karlsson.2017, "#E31837", "#C69214", "Erik Karlsson (2017)")
karlsson.2017.locations.plot

karlsson.2018.locations.plot = graph.shot.locations(karlsson.2018, "#006D75", "#EA7200", "Erik Karlsson (2018)")
karlsson.2018.locations.plot
```

Let's look at this goal percentage per game now.

```{r}
karlsson.2015.gp.plot = graph.trend(karlsson.2015.game.gp, "Shooting (Goal) Percentage", "#E31837", "#C69214", "Erik Karlsson (2015)")
karlsson.2015.gp.plot

karlsson.2016.gp.plot = graph.trend(karlsson.2016.game.gp, "Shooting (Goal) Percentage", "#E31837", "#C69214", "Erik Karlsson (2016)")
karlsson.2016.gp.plot

karlsson.2017.gp.plot = graph.trend(karlsson.2017.game.gp, "Shooting (Goal) Percentage", "#E31837", "#C69214", "Erik Karlsson (2017)")
karlsson.2017.gp.plot

karlsson.2018.gp.plot = graph.trend(karlsson.2018.game.gp, "Shooting (Goal) Percentage", "#006D75", "#EA7200", "Erik Karlsson (2018)")
karlsson.2018.gp.plot
```

### Kris Letang

Kris Letang has suffered through many major injuries but still performs like a Norris Trophy winning defensemen. Let's see his growth through the years.

```{r}
letang.2015 = get.skater.data(analysis.2015, "Kris Letang")
letang.2016 = get.skater.data(analysis.2016, "Kris Letang")
letang.2017 = get.skater.data(analysis.2017, "Kris Letang")
letang.2018 = get.skater.data(analysis.2018, "Kris Letang")
```

Let's get some of his stats.

```{r}
letang.2015.sp = get.save.percent(letang.2015)
letang.2015.game.sp = get.game.save.percent(letang.2015)
letang.2016.sp = get.save.percent(letang.2016)
letang.2016.game.sp = get.game.save.percent(letang.2016)
letang.2017.sp = get.save.percent(letang.2017)
letang.2017.game.sp = get.game.save.percent(letang.2017)
letang.2018.sp = get.save.percent(letang.2018)
letang.2018.game.sp = get.game.save.percent(letang.2018)

letang.2015.gp = get.goal.percent(letang.2015)
letang.2015.game.gp = get.game.goal.percent(letang.2015)
letang.2016.gp = get.goal.percent(letang.2016)
letang.2016.game.gp = get.game.goal.percent(letang.2016)
letang.2017.gp = get.goal.percent(letang.2017)
letang.2017.game.gp = get.game.goal.percent(letang.2017)
letang.2018.gp = get.goal.percent(letang.2018)
letang.2018.game.gp = get.game.goal.percent(letang.2018)

letang.2015.spg = get.shots.per.goal(letang.2015)
letang.2015.game.spg = get.game.shots.per.goal(letang.2015)
letang.2016.spg = get.shots.per.goal(letang.2016)
letang.2016.game.spg = get.game.shots.per.goal(letang.2016)
letang.2017.spg = get.shots.per.goal(letang.2017)
letang.2017.game.spg = get.game.shots.per.goal(letang.2017)
letang.2018.spg = get.shots.per.goal(letang.2018)
letang.2018.game.spg = get.game.shots.per.goal(letang.2018)
```
...
| Season | Save Percent | Goal Percent | Shots per Goal |
| ------ | ------------ | ------------ | -------------- |
| 2015-2016 | `r letang.2015.sp` | `r letang.2015.gp` | `r letang.2015.spg` |
| 2016-2017 | `r letang.2016.sp` | `r letang.2016.gp` | `r letang.2016.spg` |
| 2017-2018 | `r letang.2017.sp` | `r letang.2017.gp` | `r letang.2017.spg` |
| 2018-2019 | `r letang.2018.sp` | `r letang.2018.gp` | `r letang.2018.spg` |

Let's take a look at his heatmaps.

```{r}
letang.2015.locations.plot = graph.shot.locations(letang.2015, "#000000", "#FCB514", "Kris Letang (2015)")
letang.2015.locations.plot

letang.2016.locations.plot = graph.shot.locations(letang.2016, "#000000", "#FCB514", "Kris Letang (2016)")
letang.2016.locations.plot

letang.2017.locations.plot = graph.shot.locations(letang.2017, "#000000", "#FCB514", "Kris Letang (2017)")
letang.2017.locations.plot

letang.2018.locations.plot = graph.shot.locations(letang.2018, "#000000", "#FCB514", "Kris Letang (2018)")
letang.2018.locations.plot
```

Let's look at this goal percentage per game now.

```{r}
letang.2015.gp.plot = graph.trend(letang.2015.game.gp, "Shooting (Goal) Percentage", "#000000", "#FCB514", "Kris Letang (2015)")
letang.2015.gp.plot

letang.2016.gp.plot = graph.trend(letang.2016.game.gp, "Shooting (Goal) Percentage", "#000000", "#FCB514", "Kris Letang (2016)")
letang.2016.gp.plot

letang.2017.gp.plot = graph.trend(letang.2017.game.gp, "Shooting (Goal) Percentage", "#000000", "#FCB514", "Kris Letang (2017)")
letang.2017.gp.plot

letang.2018.gp.plot = graph.trend(letang.2018.game.gp, "Shooting (Goal) Percentage", "#000000", "#FCB514", "Kris Letang (2018)")
letang.2018.gp.plot
```